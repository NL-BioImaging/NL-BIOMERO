...
environment:
  ...
  # Submit image pulls to the scheduler instead of running on the login node.
  BIOMERO_IMAGE_PULL_VIA_SBATCH: "false"
  BIOMERO_PULL_CPUS: "8"
  BIOMERO_PULL_MEM: "32G"

  # --- Apptainer tmp / cache dirs ---
  # Override where Apptainer/Singularity writes tmp and cache during image pulls.
  # Needed when the default location is too small for large images.
