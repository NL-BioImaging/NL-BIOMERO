...
1. **BIOMERO.scripts**
   - Source: [NL-BioImaging/biomero-scripts](https://github.com/NL-BioImaging/biomero-scripts)
...
2. **OMERO.figure Script**
   - Source: [ome/omero-figure](https://raw.githubusercontent.com/ome/omero-figure/refs/heads/master/omero_figure/scripts/omero/figure_scripts/Figure_To_Pdf.py)
...
3. **Labels2ROIs Script**
   - Source: [Cellular-Imaging-Amsterdam-UMC/label2rois](https://raw.githubusercontent.com/Cellular-Imaging-Amsterdam-UMC/label2rois/main/Labels2Rois.py)
...
- [OMERO Web](omeroweb.md) - Web interface development
- [BIOMERO Worker](biomeroworker.md) - Worker node development
- [OMERO Developer Documentation](https://omero.readthedocs.io/en/stable/developers/)
